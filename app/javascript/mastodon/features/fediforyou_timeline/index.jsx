...
import CompassIcon from '@/material-icons/400-24px/compass.svg?react';
...
const messages = defineMessages({
  title: { id: 'column.fediforyou', defaultMessage: 'FediForYou' },
  show_announcements: { id: 'fediforyou.show_announcements', defaultMessage: 'Show announcements' },
  hide_announcements: { id: 'fediforyou.hide_announcements', defaultMessage: 'Hide announcements' },
});
...
class FediForYouTimeline extends PureComponent {
  static propTypes = {
  ...
  render () {
    ...
    return (
      <Column bindToDocument={!multiColumn} ref={this.setRef} label={intl.formatMessage(messages.title)}>
        <ColumnHeader
          icon='compass'
          iconComponent={matchesBreakpoint ? SymbolLogo : CompassIcon}
...
export default connect(mapStateToProps)(withBreakpoint(withIdentity(injectIntl(FediForYouTimeline))));
